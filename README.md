...
|2023-09-14 10:13:40|[API-T00L](https://github.com/pykiller/API-T00L)|v1.2|新增飞书API利用。|
...
| 提交时间 | 项目名称 | 更新内容 |
| :---- | :---- | :---- |
|2023-09-27 00:00:02|[free](https://github.com/freefq/free)|updated_at 09-27 08:00|
|2023-09-26 23:57:04|[awesome-chatgpt-z<br>h](https://github.com/yzfly/awesome-chatgpt-zh)|add FLAML, txtai|
|2023-09-26 23:34:58|[PocOrExp_in_Githu<br>b](https://github.com/ycdxsb/PocOrExp_in_Github)|update 2023-09-27 07:34:58|
|2023-09-26 18:41:37|[wpscan](https://github.com/wpscanteam/wpscan)|Bump version|
|2023-09-26 17:41:40|[dbeaver](https://github.com/dbeaver/dbeaver)|dbeaver/dbeaver#15951 UI unresponsive while loading<br> a larger JSONB (#21134)  * dbeaver/dbeaver#15951 UI<br> unresponsive while loading a larger JSONB  object  <br>  Provided functionality for restriction of large fi<br>le content  representation.    * dbeaver/dbeaver#159<br>51 UI unresponsive while loading a larger JSONB    F<br>ixed code style 4 spaces instead of tabs,etc    * db<br>eaver/dbeaver#15951 UI unresponsive while loading a <br>larger JSONB    Reworked to use getContentLength fro<br>m DBValue object    * dbeaver/dbeaver#15951 UI unres<br>ponsive while loading a larger JSONB    Applied code<br>style for UIUtils    * dbeaver/dbeaver#15951 UI unre<br>sponsive while loading a larger JSONB    Fixed code <br>style PrefPageResultSetMain    * dbeaver/dbeaver#159<br>51 UI unresponsive while loading a larger JSONB    C<br>ode style check fixed new method in  UIUtils class  <br>  * dbeaver/dbeaver#15951 UI unresponsive while load<br>ing a larger JSONB    Fixed Javadoc tag @param shoul<br>d be preceded with an empty line.    * dbeaver/dbeav<br>er#15951 UI unresponsive while loading a larger JSON<br>B    Fixed Javadoc tag @param should be preceded wit<br>h an empty line.    * dbeaver/dbeaver#15951 UI unres<br>ponsive while loading a larger JSONB    Drawing func<br>tion moved to paintListener in AbstractTextPanelEdit<br>or    * dbeaver/dbeaver#15951 UI unresponsive while <br>loading a larger JSONB    Code style check in Abstra<br>ctTextPanelEditor    * dbeaver/dbeaver#15951 UI unre<br>sponsive while loading a larger JSONB    Fixed layou<br>t of groups controls to avoid collapsing text editor<br>s.  Minimal size added also.    * dbeaver/dbeaver#15<br>951 UI unresponsive while loading a larger JSONB    <br>Code style fixed    * dbeaver/dbeaver#15951 UI unres<br>ponsive while loading a larger JSONB    Constant agg<br>regated to function, Resize used.    * dbeaver/dbeav<br>er#15951 UI unresponsive while loading a larger JSON<br>B    Rework to message label as a status panel on th<br>e bottom editor.  Revert preferences page code for b<br>etter day  Restricted range of representing content <br>value.    * dbeaver/dbeaver#15951 UI unresponsive wh<br>ile loading a larger JSONB    Code style fixed    * <br>dbeaver/dbeaver#15951 UI unresponsive while loading <br>a larger JSONB    Code style fixed  throws has incor<br>rect indentation level 8, expected level should be 1<br>2    * dbeaver/dbeaver#15951 UI unresponsive while l<br>oading a larger JSONB    Fixed message text    * dbe<br>aver/dbeaver#15951 UI unresponsive while loading a l<br>arger JSONB    Unused class removed.    * dbeaver/db<br>eaver#15951 UI unresponsive while loading a larger J<br>SONB    Unused variable removed.    * Reorganized me<br>thod signature to column arg style    * dbeaver/dbea<br>ver#1017 Reorganized to read values from DBDContentS<br>torage    * dbeaver/dbeaver#15951 Reorganized to rea<br>d values from DBDContentStorage    * dbeaver/dbeaver<br>#15951 Removed limits (input key listener)    * dbea<br>ver/dbeaver#15951 Reorganized preferences page for M<br>ax Content  Length    * dbeaver/dbeaver#15951 Rename<br>d methods, load chunk of data    * dbeaver/dbeaver#1<br>5951 Limit size of reading DataContent    --------- <br>   Co-authored-by: MashaKorax   Co-authored-by: Eliz<br>abeth |
|2023-09-26 17:38:41|[neuvector](https://github.com/neuvector/neuvector)|Merge pull request #1029 from williamlin-suse/main <br> NVSHAS-8320: the criteria info is missing in Admiss<br>ion.Control.Denied…|
|2023-09-26 17:16:42|[grype](https://github.com/anchore/grype)|chore(deps): bump actions/checkout from 4.0.0 to 4.<br>1.0 (#1519)  * chore(deps): bump actions/checkout fr<br>om 4.0.0 to 4.1.0    Bumps  from 4.0.0 to 4.1.0.  - <br>  -   -     ---  updated-dependencies:  - dependency<br>-name: actions/checkout    dependency-type: direct:p<br>roduction    update-type: version-update:semver-mino<br>r  ...    Signed-off-by: dependabot[bot]     * chore<br>: add version comment    Signed-off-by: Will Murphy <br>    ---------    Signed-off-by: dependabot[bot]   Si<br>gned-off-by: Will Murphy   Co-authored-by: dependabo<br>t[bot]   Co-authored-by: Will Murphy |
|2023-09-26 15:33:15|[afrog](https://github.com/zan8in/afrog)|update|
|2023-09-26 15:14:25|[syft](https://github.com/anchore/syft)|chore(deps): update bootstrap tools to latest versi<br>ons (#2171)  Signed-off-by: GitHub   Co-authored-by:<br> spiffcs |
...
|2023-09-26 12:36:57|[v2rayfree](https://github.com/aiboboxx/v2rayfree)|update|
|2023-09-26 10:30:49|[nemo_go](https://github.com/hanc00l/nemo_go)|Update: 信息收集全面支持ipv6！|
|2023-09-26 10:18:01|[rustdesk](https://github.com/rustdesk/rustdesk)|Merge pull request #5822 from 21pages/me  show user<br>name followed by a 'Me' tag|
|2023-09-26 08:55:23|[trivy](https://github.com/aquasecurity/trivy)|refactor(purl): use TypeApk from purl (#5232)  * us<br>e TypeApk from purl  * refactor: some tweaks  Signed<br>-off-by: knqyf263   ---------  Signed-off-by: knqyf2<br>63  Co-authored-by: knqyf263 |
...
|2023-09-26 02:52:22|[arthas](https://github.com/alibaba/arthas)|Prettified Code!|
...
|2023-09-12 00:57:05|[0day](https://github.com/helloexp/0day)|add CVE-2023-37582 RocketMQ RCE|## 所有项目
# 渗透测试
## 信息收集
### 资产测绘采集
| 项目名称 | 版本 | 项目描述 |
...
| [codeql-cli-binari<br>es](https://github.com/github/codeql-cli-binaries) | v2.14.6 | Binaries for the CodeQL CLI |
| [CodeQLpy](https://github.com/webraybtl/CodeQLpy) |  | CodeQLpy是一款基于CodeQL实现的半自动化代码审计工具，目前仅支持<br>java语言。实现从源码反编译，数据库生成，脆弱性发现的全过程，可<br>以辅助代码审计人员快速定位源码可能存在的漏洞。 |
### 容器漏洞扫描
| 项目名称 | 版本 | 项目描述 |
| :---- | :---- | :---- |
...
| :---- | :---- | :---- |
| [veinmind-tools](https://github.com/chaitin/veinmind-tools) | v2.1.5 | veinmind-tools 是由长亭科技自研，基于 veinmind-sdk 打造的容器<br>安全工具集 |
| [grype](https://github.com/anchore/grype) | v0.69.0 | A vulnerability scanner for container images and filesystems |
#### 容器漏洞分析工具
| 项目名称 | 版本 | 项目描述 |
| :---- | :---- | :---- |
...
| 项目名称 | 版本 | 项目描述 |
| :---- | :---- | :---- |
| [trivy](https://github.com/aquasecurity/trivy) | v0.45.1 | Find vulnerabilities, misconfigurations, secrets, SBOM in cont<br>ainers, Kubernetes, code repositories, clouds and more |
#### 容器镜像扫描
| 项目名称 | 版本 | 项目描述 |
| :---- | :---- | :---- |
| [grype](https://github.com/anchore/grype) | v0.69.0 | A vulnerability scanner for container images and filesystems |
| [syft](https://github.com/anchore/syft) | v0.91.0 | CLI tool and library for generating a Software Bill of Materia<br>ls from container images and filesystems |
#### K8S漏洞扫描
| 项目名称 | 版本 | 项目描述 |
| :---- | :---- | :---- |
...
| [OneScan](https://github.com/vaycore/OneScan) | v1.3.0 | OneScan是递归目录扫描的BurpSuite插件 |
...
| 项目名称 | 版本 | 项目描述 |
| :---- | :---- | :---- |
| [dbeaver](https://github.com/dbeaver/dbeaver) | 23.2.1 | Free universal database tool and SQL client |
## MySQL实时监控工具
| 项目名称 | 版本 | 项目描述 |
| :---- | :---- | :---- |
...
| 项目名称 | 版本 | 项目描述 |
| :---- | :---- | :---- |
| [Umi-OCR](https://github.com/hiroi-sora/Umi-OCR) | v1.3.6 | OCR图片转文字识别软件，完全离线。截屏/批量导入图片，支持多国语<br>言、合并段落、竖排文字。可排除水印区域，提取干净的文本。基于 Pad<br>dleOCR 。 |
## chatgpt
| 项目名称 | 版本 | 项目描述 |
| :---- | :---- | :---- |
...
| [dperf](https://github.com/baidu/dperf) | v1.5.0 | dperf is a 100Gbps network load tester. |
## web靶场
| 项目名称 | 版本 | 项目描述 |
| :---- | :---- | :---- |
