...
| 提交时间 | 项目名称 | 更新内容 |
| :---- | :---- | :---- |
|2023-08-21 00:00:03|[free](https://github.com/freefq/free)|updated_at 08-21 08:00|
|2023-08-20 23:12:11|[PocOrExp_in_Githu<br>b](https://github.com/ycdxsb/PocOrExp_in_Github)|update 2023-08-21 07:12:11|
|2023-08-20 16:08:56|[trivy](https://github.com/aquasecurity/trivy)|feat(vuln): support last_affected field from osv (#<br>4944)  * feat(vuln): support last_affected field fro<br>m osv  * run go mod tidy  * bump trivy-db|
|2023-08-20 13:44:47|[rustdesk](https://github.com/rustdesk/rustdesk)|Merge pull request #5449 from 21pages/fix  save ab <br>password to recent PeerConfig when connected with it|
|2023-08-20 12:30:46|[v2rayfree](https://github.com/aiboboxx/v2rayfree)|update|
|2023-08-20 10:10:20|[afrog](https://github.com/zan8in/afrog)|update|
|2023-08-20 06:44:07|[nemo_go](https://github.com/hanc00l/nemo_go)|Update: 完善onlineapi查询的查询语句、去除可能包含敏<br>感信息的过滤词（可能API导致查询失败）|
...
|2023-08-20 02:46:23|[v2rayA](https://github.com/v2rayA/v2rayA)|fix(xtls): panic #1039|
...
|2023-08-18 08:47:01|[OA-EXPTOOL](https://github.com/LittleBear4/OA-EXPTOOL)|Add files via upload|
|2023-08-18 05:58:27|[Viper](https://github.com/FunnyWolf/Viper)|Update issue templates|
|2023-08-18 03:03:26|[arthas](https://github.com/alibaba/arthas)|Add -s,-g,-a,-l option for profiler command, better<br> support farmat option (#2613)|
...
|2023-08-06 04:13:27|[captcha-killer-mo<br>dified](https://github.com/f0ng/captcha-killer-modified)|Update FAQ.md|## 所有项目
# 渗透测试
## 信息收集
### 资产测绘采集
| 项目名称 | 版本 | 项目描述 |
...
| [ObserverWard](https://github.com/0x727/ObserverWard) | v2023.8<br>.14 | Cross platform community web fingerprint identification tool |
### WAF识别
| 项目名称 | 版本 | 项目描述 |
| :---- | :---- | :---- |
