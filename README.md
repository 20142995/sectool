...
|2023-08-21 03:18:30|[rustdesk](https://github.com/rustdesk/rustdesk)|1.2.2|      > Winget, FDroid, Apple Sillico<br>n, Google Play / App Store update will<br> come soon.    x86-64:  |  |   AArch64<br> (ARM64):   |  |     More:       Chang<br>elog    - Add separate window mode (ta<br>b window by default), https://github.c<br>om/rustdesk/rustdesk/discussions/2889 <br> - Fix and improve responsiveness issu<br>e introduced in 1.2.0. https://github.<br>com/rustdesk/rustdesk/discussions/5231<br>  - Add device list batch handle  - Ad<br>d command to assign user and strategy <br>for   - Optimize address book, syncing<br> password, alias name, device name etc<br>, add tag color, improve error and upd<br>ate status handling  - Fix windows fil<br>e copy/paste  - Fix "waiting for image<br>..." still shown after receiving image<br> bug, refactored rust->flutter message<br> handling https://github.com/rustdesk/<br>rustdesk/issues/4533  - Improve some t<br>ouchpad support, https://github.com/ru<br>stdesk/rustdesk/pull/5049  - Bug fixes<br>.      |
...
|2023-08-19 13:47:29|[v2rayA](https://github.com/v2rayA/v2rayA)|v2.2.0|* 修复 ssr 问题  * 支持 tuic 协议    <br>## What's Changed  * chore(deps): bump<br> decode-uri-component from 0.2.0 to 0.<br>2.2 in /gui by @dependabot in https://<br>github.com/v2rayA/v2rayA/pull/731  * c<br>hore(deps): bump github.com/gin-gonic/<br>gin from 1.7.1 to 1.7.7 in /service by<br> @dependabot in https://github.com/v2r<br>ayA/v2rayA/pull/817  * chore(deps): bu<br>mp word-wrap from 1.2.3 to 1.2.5 in /g<br>ui by @dependabot in https://github.co<br>m/v2rayA/v2rayA/pull/1019  * chore(dep<br>s): bump github.com/gin-gonic/gin from<br> 1.7.7 to 1.9.1 in /service by @depend<br>abot in https://github.com/v2rayA/v2ra<br>yA/pull/1021  * chore(deps): bump word<br>-wrap from 1.2.3 to 1.2.5 in /ngui by <br>@dependabot in https://github.com/v2ra<br>yA/v2rayA/pull/1023  * ci(release_feat<br>_v5.yml): update by @MarksonHon in htt<br>ps://github.com/v2rayA/v2rayA/pull/103<br>2  * ci(release_feat_v5): Fixed GitHub<br> releases by @MarksonHon in https://gi<br>thub.com/v2rayA/v2rayA/pull/1035  * fi<br>x(ssr): broken ssr dialer  * feat(tuic<br>): support tuic protocol      **Full C<br>hangelog**: https://github.com/v2rayA/<br>v2rayA/compare/v2.1.3...v2.2.0|
...
|2023-08-22 00:00:03|[free](https://github.com/freefq/free)|updated_at 08-22 08:00|
|2023-08-21 23:12:42|[PocOrExp_in_Githu<br>b](https://github.com/ycdxsb/PocOrExp_in_Github)|update 2023-08-22 07:12:42|
...
|2023-08-21 15:49:13|[dbeaver](https://github.com/dbeaver/dbeaver)|Merge branch 'devel' of https://github.com/dbeaver/<br>dbeaver into devel|
|2023-08-21 14:40:04|[rustdesk](https://github.com/rustdesk/rustdesk)|Merge pull request #5465 from jimmyGALLAND/master-1<br>  Improve some translate fr.rs|
|2023-08-21 14:37:11|[syft](https://github.com/anchore/syft)|chore(deps): bump github.com/jinzhu/copier from 0.3<br>.5 to 0.4.0 (#2045)  Bumps  from 0.3.5 to 0.4.0.  - <br>    ---  updated-dependencies:  - dependency-name: g<br>ithub.com/jinzhu/copier    dependency-type: direct:p<br>roduction    update-type: version-update:semver-mino<br>r  ...    Signed-off-by: dependabot[bot]   Co-author<br>ed-by: dependabot[bot] |
|2023-08-21 14:26:54|[v2rayA](https://github.com/v2rayA/v2rayA)|chore: bump quic-go to v0.38.0|
|2023-08-21 14:09:05|[FreeRDP](https://github.com/FreeRDP/FreeRDP)|[server,shadow] fix initialization of [MS-RDPEGFX] <br> the channel was initialized with handling messages <br>in a thread and handling the channel messages on mai<br>n thread. fix that.|
|2023-08-21 13:13:54|[ObserverWard](https://github.com/0x727/ObserverWard)|添加从API读取多个目标支持字段|
|2023-08-21 12:34:49|[v2rayfree](https://github.com/aiboboxx/v2rayfree)|update|
...
|2023-08-21 08:51:22|[murphysec](https://github.com/murphysecurity/murphysec)|feat(cli): env TLE_ALLOW_INSECURE|
|2023-08-21 08:42:01|[Viper](https://github.com/FunnyWolf/Viper)|update version 1.6.4|
|2023-08-21 08:01:06|[OA-EXPTOOL](https://github.com/LittleBear4/OA-EXPTOOL)|Add files via upload|
...
|2023-08-07 03:52:52|[Sec-Tools](https://github.com/jwt1399/Sec-Tools)|Update README.md|## 所有项目
# 渗透测试
## 信息收集
### 资产测绘采集
| 项目名称 | 版本 | 项目描述 |
...
| [nuclei](https://github.com/projectdiscovery/nuclei) | v2.9.11 | Fast and customizable vulnerability scanner based on simple YA<br>ML based DSL. |
...
| 项目名称 | 版本 | 项目描述 |
| :---- | :---- | :---- |
| [neuvector](https://github.com/neuvector/neuvector) | v5.2.0-<br>s1 |  |
...
| [safeline](https://github.com/chaitin/safeline) | v3.0.1 | 一款足够简单、足够好用、足够强的免费 WAF。基于业界领先的语义引<br>擎检测技术，作为反向代理接入，保护你的网站不受黑客攻击。 |
## 欺骗防御
| 项目名称 | 版本 | 项目描述 |
| :---- | :---- | :---- |
...
| 项目名称 | 版本 | 项目描述 |
| :---- | :---- | :---- |
| [dbeaver](https://github.com/dbeaver/dbeaver) | 23.1.5 | Free universal database tool and SQL client |
## MySQL实时监控工具
| 项目名称 | 版本 | 项目描述 |
| :---- | :---- | :---- |
...
| 项目名称 | 版本 | 项目描述 |
| :---- | :---- | :---- |
| [v2rayA](https://github.com/v2rayA/v2rayA) | v2.2.0 | A web GUI client of Project V which supports V2Ray, Xray, SS, <br>SSR, Trojan and Juicity. 🚀🚀 |
