# 更新于 2023-01-03 09:02:31

## 近30天release更新记录
| 更新时间 | 项目名称 | 版本 | 更新内容 |
| :---- | :---- | :---- | :---- |
|2023-01-02 13:34:59|[nuclei](https://github.com/projectdiscovery/nuclei)|v2.8.4|## What's Changed* Added **scan strateg<br>y option** by @tarunKoyalwar in https://<br>github.com/projectdiscovery/nuclei/pull/<br>3075* Added exporter for splunk reportin<br>g by @ChrisMandich in https://github.com<br>/projectdiscovery/nuclei/pull/3008* Adde<br>d initialization of flags with nil slice<br> by @Mzack9999 in https://github.com/pro<br>jectdiscovery/nuclei/pull/3089* Added **<br>YAML inclusion support** by @Mzack9999 i<br>n https://github.com/projectdiscovery/nu<br>clei/pull/1767* Added stop-at-first-matc<br>h for headless protocol by @tarunKoyalwa<br>r in https://github.com/projectdiscovery<br>/nuclei/pull/3034* Added support to quer<br>y DNS TLSA record by @nothinux in https:<br>//github.com/projectdiscovery/nuclei/pul<br>l/3054* Added release announcement to di<br>scord server by @ehsandeep in https://gi<br>thub.com/projectdiscovery/nuclei/pull/31<br>20* Added more error coverage to skip ho<br>st to scan by @ehsandeep in https://gith<br>ub.com/projectdiscovery/nuclei/pull/3121<br>* Added skipped host information on defa<br>ult run by @ehsandeep in https://github.<br>com/projectdiscovery/nuclei/pull/3123* A<br>dded template path in json output by @Sh<br>ubhamRasal in https://github.com/project<br>discovery/nuclei/pull/3093* Added ParseF<br>romReader function by @ShubhamRasal in h<br>ttps://github.com/projectdiscovery/nucle<br>i/pull/3031* Added cli variables support<br> in SSL Protocol by @xm1k3 in https://gi<br>thub.com/projectdiscovery/nuclei/pull/30<br>69* Fixed bug to automerge url parameter<br>s from input and templates by @tarunKoya<br>lwar in https://github.com/projectdiscov<br>ery/nuclei/pull/3010* Fixed bug in markd<br>own export to break line characters with<br> HTML notation by @vzamanillo in https:/<br>/github.com/projectdiscovery/nuclei/pull<br>/3014* Fixed bug with -resume option rew<br>riting the output file contents, so prev<br>ious data removed by @xm1k3 in https://g<br>ithub.com/projectdiscovery/nuclei/pull/2<br>890* Fixed tlsx ocsp panic by @tarunKoya<br>lwar in https://github.com/projectdiscov<br>ery/nuclei/pull/3041* Fixed workflow tem<br>plates when creating inputhttp helper by<br> @owenrumney in https://github.com/proje<br>ctdiscovery/nuclei/pull/3049* Fixed **me<br>mory leak on hmap** with LRU by @Mzack99<br>99 in https://github.com/projectdiscover<br>y/nuclei/pull/3052* Fixed debug flags do<br> not work correctly with headless templa<br>tes by @xm1k3 in https://github.com/proj<br>ectdiscovery/nuclei/pull/3030* Fixed iss<br>ue with deny list attribute in file prot<br>ocol by @Mzack9999 in https://github.com<br>/projectdiscovery/nuclei/pull/3037* Fixe<br>d issue with -scan-all-ips option by @ta<br>runKoyalwar in https://github.com/projec<br>tdiscovery/nuclei/pull/3080* Fixed **mos<br>t go routine leaks** by @Mzack9999 in ht<br>tps://github.com/projectdiscovery/nuclei<br>/pull/3073* Fixed url input panic by @ta<br>runKoyalwar in https://github.com/projec<br>tdiscovery/nuclei/pull/3092* Fixed golan<br>g example input by @jonathanwalker in ht<br>tps://github.com/projectdiscovery/nuclei<br>/pull/3088* Fixed issue in dsl to avoid <br>unwanted debug print by @Mzack9999 in ht<br>tps://github.com/projectdiscovery/nuclei<br>/pull/2995* Fixed issue with failed item<br>s reporting error in hosterrorscache by <br>@xm1k3 in https://github.com/projectdisc<br>overy/nuclei/pull/3047* Refactor around <br>the input to type conversion by @vzamani<br>llo in https://github.com/projectdiscove<br>ry/nuclei/pull/3007Issues closed in rele<br>ase - https://github.com/projectdiscover<br>y/nuclei/milestone/21?closed=1## New Con<br>tributors* @shashikarsiddharth made thei<br>r first contribution in https://github.c<br>om/projectdiscovery/nuclei/pull/2876* @C<br>hrisMandich made their first contributio<br>n in https://github.com/projectdiscovery<br>/nuclei/pull/3008* @jessekelly881 made t<br>heir first contribution in https://githu<br>b.com/projectdiscovery/nuclei/pull/2777*<br> @jonathanwalker made their first contri<br>bution in https://github.com/projectdisc<br>overy/nuclei/pull/3088**Full Changelog**<br>: https://github.com/projectdiscovery/nu<br>clei/compare/v2.8.3...v2.8.4|
...
| 提交时间 | 项目名称 | 更新内容 |
| :---- | :---- | :---- |
|2023-01-03 01:00:18|[NucleiTP](https://github.com/ExpLangcn/NucleiTP)|更新啦❤️|
|2023-01-02 23:49:56|[PocOrExp_in_Github](https://github.com/ycdxsb/PocOrExp_in_Github)|update 2023-01-03 07:49:56|
|2023-01-02 13:34:08|[nuclei](https://github.com/projectdiscovery/nuclei)|Merge pull request #3118 from projectdiscovery/devNucl<br>ei v2.8.4 (bugfix release)|
|2023-01-02 10:01:45|[afrog](https://github.com/zan8in/afrog)|update poc|
...
| [nuclei](https://github.com/projectdiscovery/nuclei) | v2.8.4 | Fast and customizable vulnerability scanner based on simple YAML<br> based DSL. |
