...
|2023-09-03 06:11:01|[v2rayA](https://github.com/v2rayA/v2rayA)|v2.2.3|Fix some problems.    1. Juicity/Tuic<br> cannot work.  2. Incorrect value show<br>ing of allow_insecure for Juicity/Tuic<br>.  3. Cannot automatically keep runnin<br>g after reboot.    **Full Changelog**:<br> https://github.com/v2rayA/v2rayA/comp<br>are/v2.2.2...v2.2.3|
...
| 提交时间 | 项目名称 | 更新内容 |
| :---- | :---- | :---- |
|2023-09-05 00:00:03|[free](https://github.com/freefq/free)|updated_at 09-05 08:00|
|2023-09-04 23:13:56|[PocOrExp_in_Githu<br>b](https://github.com/ycdxsb/PocOrExp_in_Github)|update 2023-09-05 07:13:56|
...
|2023-09-04 15:23:42|[rustdesk](https://github.com/rustdesk/rustdesk)|Merge pull request #5600 from fufesou/fix/mobile_co<br>nnecting_canvas_color  fix, mobile connecting canvas<br> color|
|2023-09-04 14:21:41|[dbeaver](https://github.com/dbeaver/dbeaver)|dbeaver/pro#1872 Delete redundant config files|
...
|2023-09-04 12:35:55|[v2rayfree](https://github.com/aiboboxx/v2rayfree)|update|
...
|2023-09-04 10:24:57|[FreeRDP](https://github.com/FreeRDP/FreeRDP)|[core,orders] fix reading order number field  the f<br>ield for delta rectangles/points/... are only transm<br>itted if they changed from the previous order of the<br> same type. So keep the original value and update on<br>ly if a new one is read.|
...
|2023-09-03 12:24:13|[v2rayA](https://github.com/v2rayA/v2rayA)|fix: building|
|2023-09-03 08:59:16|[afrog](https://github.com/zan8in/afrog)|update|
...
|2023-08-21 12:24:24|[gshark](https://github.com/madneal/gshark)|modify struct|## 所有项目
# 渗透测试
## 信息收集
### 资产测绘采集
| 项目名称 | 版本 | 项目描述 |
...
| 项目名称 | 版本 | 项目描述 |
| :---- | :---- | :---- |
| [Elkeid](https://github.com/bytedance/Elkeid) | v1.7.0.<br>13-drive<br>r-ko-202<br>30831 | Elkeid is an open source solution that can meet the security r<br>equirements of various workloads such as hosts, containers and <br>K8s, and serverless. It is derived from ByteDance's internal be<br>st practices. |
...
| 项目名称 | 版本 | 项目描述 |
| :---- | :---- | :---- |
| [v2rayA](https://github.com/v2rayA/v2rayA) | v2.2.3 | A web GUI client of Project V which supports VMess, VLESS, SS,<br> SSR, Trojan, Tuic and Juicity protocols. 🚀 |
