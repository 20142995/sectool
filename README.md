...
|2023-09-12 14:29:14|[codeql-cli-binari<br>es](https://github.com/github/codeql-cli-binaries)|v2.14.4|### Potentially breaking changes    -<br> The CodeQL CLI no longer supports the<br> SEMMLE_JAVA_ARGS environment variable<br>. All previous versions of the CodeQL <br>CLI perform command substitution on th<br>e SEMMLE_JAVA_ARGS value (for example,<br> replacing '$(echo foo)' with 'foo') w<br>hen starting a new Java virtual machin<br>e, which, depending on the execution e<br>nvironment, may have security implicat<br>ions.  Users are advised to check thei<br>r environments for possible SEMMLE_JAV<br>A_ARGS misuse.    ### New Features    <br>- The Java extractor now supports file<br>s that use Lombok.    ### Bugs fixed  <br>  - codeql database init (and github/c<br>odeql-action/init@v2 on GitHub Actions<br>) should no longer hang or crash for t<br>raced languages on 64-bit Windows mach<br>ines when certain antivirus software i<br>s installed.  - During codeql pack cre<br>ate and codeql pack publish, a source <br>version of a pack coming from --additi<br>onal-packs can explicitly be used to o<br>verride a requested pack version even <br>if this source version is incompatible<br> with the requested version in the pac<br>k file. Previously, this would fail wi<br>th a confusing error message.  - Fixed<br> a bug where codeql database interpret<br>-results hangs when a path query produ<br>ces a result that has no paths from so<br>urce to sink.    ### Miscellaneous    <br>- The build of Eclipse Temurin OpenJDK<br> that is bundled with the CodeQL    CL<br>I has been updated to version 17.0.8. <br>   For more information about the chan<br>ges included in this release, see the <br>.    You can download _either_ the cod<br>eql-PLATFORM.zip for your platform, _o<br>r_ the generic codeql.zip which contai<br>ns binaries for all supported platform<br>s. Please ignore the additional "sourc<br>e code" downloads below the .zip artif<br>acts.    This release is compatible wi<br>th the CodeQL language packs from .  |
...
| 提交时间 | 项目名称 | 更新内容 |
| :---- | :---- | :---- |
|2023-09-13 00:00:02|[free](https://github.com/freefq/free)|updated_at 09-13 08:00|
|2023-09-12 23:23:13|[PocOrExp_in_Githu<br>b](https://github.com/ycdxsb/PocOrExp_in_Github)|update 2023-09-13 07:23:13|
...
|2023-09-12 18:04:24|[grype](https://github.com/anchore/grype)|chore(deps): bump docker/login-action from 2 to 3 (<br>#1488)  Bumps  from 2 to 3.  -   -     ---  updated-<br>dependencies:  - dependency-name: docker/login-actio<br>n    dependency-type: direct:production    update-ty<br>pe: version-update:semver-major  ...    Signed-off-b<br>y: dependabot[bot]   Co-authored-by: dependabot[bot]<br> |
|2023-09-12 17:45:36|[ThunderSearch](https://github.com/xzajyjs/ThunderSearch)|fix bug|
|2023-09-12 17:09:18|[syft](https://github.com/anchore/syft)|chore: enforce race detector (#2122)  Previously, t<br>here were some data races in syft. Right now, none a<br>re  detected, so check for data races on the overall<br> command, and on unit  tests. (Checking for races on<br> integration tests triples the time needed  for thos<br>e tests, from ~1 minute to ~3 minutes on my workstat<br>ion, so that  was not done at this time.)    Signed-<br>off-by: Will Murphy |
|2023-09-12 14:28:21|[dbeaver](https://github.com/dbeaver/dbeaver)|dbeaver/dbeaver#21053 Display errors in the result <br>tab  (#21162)  * Display errors in the result tab #2<br>1053    The display error state reset to default in <br>case of catching errors.    * Display errors in the <br>result tab #21053    The display error state reset t<br>o default in case of catching errors.    * Display e<br>rrors in the result tab #21053    Removed unused met<br>hod    * dbeaver/dbeaver#21053 Display errors in the<br> result tab    fixed result view    * dbeaver/dbeave<br>r#21053 Display errors in the result tab    Empty li<br>ne for style check    * dbeaver/dbeaver#21053 Displa<br>y errors in the result tab    Removed the keep state<br> behavior of sash.    * dbeaver/dbeaver#21053 Displa<br>y errors in the result tab    Revert to keep changes<br> for future decision|
|2023-09-12 14:26:09|[codeql-cli-binari<br>es](https://github.com/github/codeql-cli-binaries)|Update changelog for 2.14.4|
|2023-09-12 12:50:31|[ffuf](https://github.com/ffuf/ffuf)|Add cert authentication to crawl (#713)  * Add cert<br> authentication to crawl    * Update CONTRIBUTORS.md<br>    * Update CONTRIBUTORS.md|
|2023-09-12 12:35:18|[v2rayfree](https://github.com/aiboboxx/v2rayfree)|update|
...
|2023-09-11 23:44:09|[neuvector](https://github.com/neuvector/neuvector)|Merge pull request #998 from williamlin-suse/main  <br>NVSHAS-8240: Export of group policy does not return <br>any actual YAML c…|
|2023-09-11 17:57:32|[slowhttptest](https://github.com/shekyan/slowhttptest)|support mtls (#86)|
|2023-09-11 17:35:07|[FreeRDP](https://github.com/FreeRDP/FreeRDP)|[client,common] fix multitouch "engaged" state|
|2023-09-11 16:17:55|[faker](https://github.com/joke2k/faker)|Bump version: 19.6.0 → 19.6.1|
|2023-09-11 15:11:00|[iDefender](https://github.com/wecooperate/iDefender)|update|
...
|2023-09-11 02:58:13|[vulnerability](https://github.com/lal0ne/vulnerability)|CVE-2023-40930|
|2023-09-11 00:43:57|[rustdesk](https://github.com/rustdesk/rustdesk)|Merge pull request #5651 from flusheDData/master  U<br>pdate es.rs|
...
|2023-08-29 06:09:32|[Vuln-List](https://github.com/wwl012345/Vuln-List)|Update 终端软件漏洞合集.md|## 所有项目
# 渗透测试
## 信息收集
### 资产测绘采集
| 项目名称 | 版本 | 项目描述 |
...
| [ThunderSearch](https://github.com/xzajyjs/ThunderSearch) | v2.5.1 | 【支持Fofa、Shodan、Hunter、Zoomeye、Quake网络空间搜索引擎】闪<br>电搜索器；GUI图形化渗透测试信息搜集工具；资产搜集引擎；hw红队工<br>具hvv |
