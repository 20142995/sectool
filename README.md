# 更新于 2022-11-27 21:54:26

## 近30天release更新记录
| 更新时间 | 项目名称 | 版本 | 更新内容 |
| :---- | :---- | :---- | :---- |
| 2022-11-08 12:30:23 | [ThunderSearch](https://github.com/xzajyjs/ThunderSearch) | v2.3.2 | - 增加了部分界面的英文支持- 调整了界面的大小<br>---- Partly english support- Adjusted the siz<br>e of the GUI---> md5ThunderSearch_darwin_univ<br>ersal.zip=20b1888d466e61cef77a4b42161fd783Thu<br>nderSearch_win_x86.zip=a2cd29776336d1ece4e0d4<br>94e676566a |
| 2022-11-17 14:52:04 | [subfinder](https://github.com/projectdiscovery/subfinder) | v2.5.5 | ## What's Changed* Added hunter source by @M<br>zack9999 in https://github.com/projectdiscove<br>ry/subfinder/pull/680* Added recon.cloud sour<br>ce by @Mzack9999 in https://github.com/projec<br>tdiscovery/subfinder/pull/679* Added the libr<br>ary usage example by @forgedhallpass in https<br>://github.com/projectdiscovery/subfinder/pull<br>/693* Added callback function by @ShubhamRasa<br>l in https://github.com/projectdiscovery/subf<br>inder/pull/699* Added dynamic year ranges for<br> commoncrawl by @vzamanillo in https://github<br>.com/projectdiscovery/subfinder/pull/687* Fix<br>ed crtsh email values by @vzamanillo in https<br>://github.com/projectdiscovery/subfinder/pull<br>/676* Fixed source tests, added crtsh with re<br>cursion by @vzamanillo in https://github.com/<br>projectdiscovery/subfinder/pull/702* Fixed Se<br>gfault crash by @r0nk in https://github.com/p<br>rojectdiscovery/subfinder/pull/672* Removed s<br>onar source by @vzamanillo in https://github.<br>com/projectdiscovery/subfinder/pull/701## New<br> Contributors* @r0nk made their first contrib<br>ution in https://github.com/projectdiscovery/<br>subfinder/pull/672* @ShubhamRasal made their <br>first contribution in https://github.com/proj<br>ectdiscovery/subfinder/pull/699**Full Changel<br>og**: https://github.com/projectdiscovery/sub<br>finder/compare/v2.5.4...v2.5.5 |
| 2022-11-27 10:27:08 | [github-subdomains](https://github.com/gwen001/github-subdomains) | v1.1.0 |  |
| 2022-11-16 22:53:24 | [feroxbuster](https://github.com/epi052/feroxbuster) | v2.7.2 | ## What's Changed* removed superfluous if st<br>atement by @herrcykel in https://github.com/e<br>pi052/feroxbuster/pull/580* upgraded leaky-bu<br>cket to 0.12.1 by @udoprog in https://github.<br>com/epi052/feroxbuster/pull/604* updated depe<br>ndencies by @epi052 in https://github.com/epi<br>052/feroxbuster/pull/670* upgraded clap from <br>3.x to 4.x by @epi052 in https://github.com/e<br>pi052/feroxbuster/pull/671* 661 fix double di<br>r scan by @epi052 in https://github.com/epi05<br>2/feroxbuster/pull/672* fixed invalid uri exc<br>eption during extraction by @epi052 in https:<br>//github.com/epi052/feroxbuster/pull/706## Ne<br>w Contributors* @herrcykel made their first c<br>ontribution in https://github.com/epi052/fero<br>xbuster/pull/580* @udoprog made their first c<br>ontribution in https://github.com/epi052/fero<br>xbuster/pull/604**Full Changelog**: https://g<br>ithub.com/epi052/feroxbuster/compare/2.7.1...<br>v2.7.2 |
| 2022-11-07 21:04:01 | [nuclei](https://github.com/projectdiscovery/nuclei) | v2.7.9 | - Fixed gomod file - https://github.com/proj<br>ectdiscovery/nuclei/commit/de8571e726fad9b7c5<br>bb213b39b398315e7034b5 |
| 2022-11-10 15:27:37 | [afrog](https://github.com/zan8in/afrog) | v2.0.0 | **Full Changelog**: https://github.com/zan8i<br>n/afrog/compare/v1.3.9...v2.0.0- 修复 afrog <br>后台执行命令失败 BUG- 优化 afrog 稳定性，完善 <br>URL 存活验证和扫描进度检查- 优化 afrog 用户体<br>验，控制台进度显示新增 hosts、closed、time- 感<br>谢 交流群@腊子鸡 及时反馈新版本【严重】漏洞，<br>该漏洞由 target 黑名单逻辑判断不严谨导致，现已<br>修复并上传至GITHUB，请大家广而告之并重新下载 |
| 2022-11-09 00:28:07 | [pocsuite3](https://github.com/knownsec/pocsuite3) | v2.0.1 | * 修复 words 匹配器表达式执行的问题 #333, th<br>anks @soapffz* 修复模版中包含中文异常捕获的问<br>题 #334, thanks @izj007* 提高模版的鲁棒性* 支<br>持 digest_username 和 digest_password，用于 ht<br>tp 认证* 支持 negative 反向匹配器---* fix wor<br>ds matcher expression execution #333, thanks <br>@soapffz* fix catch binascii ValueError Excep<br>tion #334, thanks @izj007* improve template r<br>obustness* support digest_username and digest<br>_password* support negative matchers |
| 2022-11-13 11:40:50 | [AttackTomcat](https://github.com/tpt11fb/AttackTomcat) | V1 |  |
| 2022-11-14 08:01:41 | [OA-EXPTOOL](https://github.com/LittleBear4/OA-EXPTOOL) | v0.6 | 增加打印功能--------------------------------<br>---------------------------------------------<br>---------------------------------------------<br>-------------------------增加帆软2017敏感信息<br>泄露poc增加泛微OA_hrmcareerApply_sql poc,泛微O<br>A_mysql_config数据库信息泄漏,泛微OA_jquery_fi<br>letree,泛微OA_Verify_QuickLogin 泛微OA_signna<br>ture_任意文件访问,泛微OA_uploader_OPerate_202<br>2,泛微OA_V10_前台sql增加红帆OA_非医疗版_任意<br>文件上传增加万户OA_document_sql，万户OA Downlo<br>adServlet 任意文件读取漏洞增加nc_xbr_rce，用<br>友_U8_f5_sql，用友GRP_u8_upload_data优化优化泛<br>微OA的检测，对检测增加内容判断，提高准确性，优<br>化红帆漏洞poc增加payload，优化蓝凌oa poc的准确<br>性 去掉部分exp，优化通达后台xxs包含漏洞的线程<br>问题，优化万户模块下的poc提高准确性 |
| 2022-11-18 09:37:35 | [domain_hunter_pro](https://github.com/bit4woo/domain_hunter_pro) | v1.9-alph<br>a | **这是重构版本，与旧版本不兼容！！！这是重构<br>版本，与旧版本不兼容！！！这是重构版本，与旧版<br>本不兼容！！！**重新设计了数据库的表结构，尽量<br>提升数据库读写效率重新设计了数据对象、UI、数据<br>库之间的数据同步逻辑重新设计了数据存储的基础类<br>，保证线程安全重新设计了table中model类的部分逻<br>辑，减少内存占用优化了数据对象的字段，尽量减小<br>每个数据对象的内存占用优化了数据提取的正则表达<br>式和逻辑优化了根域名、网段作控制目标范围的逻辑<br>优化了当根域名、网段变化时，数据的刷新逻辑优化<br>了数据数据加载逻辑其他各种逻辑优化、bug修改总<br>之就是大动作，和旧版本不兼容，可能存在潜在bug<br>（虽然我已经试用一段时间，排除了很多bug），所<br>以发布一个alpha版本在正式版本之前。欢迎试用提<br>交bug，使用时建议创建新的项目数据库，不要使用<br>旧数据库文件。 |
| 2022-11-11 06:00:52 | [autoDecoder](https://github.com/f0ng/autoDecoder) | 0.19.0 | ## 2022.11.11 更新0.19修改了ui，优化了在新版<br>bp上`html`无法解析的问题 |
| 2022-11-20 09:04:40 | [knife](https://github.com/bit4woo/knife) | v2.1 | 融合U2C和Chinese2个Tab，让它们都可以支持切换<br>编码新增功能：从JS中查找URL路径后，拼接BaseURL<br>并请求其他小的更新、bug修复## What's Changed* <br>Bump gson from 2.3.1 to 2.8.9 by @dependabot <br>in https://github.com/bit4woo/knife/pull/45* <br>Bump commons-text from 1.6 to 1.10.0 by @depe<br>ndabot in https://github.com/bit4woo/knife/pu<br>ll/53## New Contributors* @dependabot made th<br>eir first contribution in https://github.com/<br>bit4woo/knife/pull/45**Full Changelog**: http<br>s://github.com/bit4woo/knife/compare/v2.0...v<br>2.1 |
| 2022-11-22 10:33:20 | [log4j2burpscanner](https://github.com/f0ng/log4j2burpscanner) | 0.20.1 | # 0.20.1更新## 2022-11-22修复`.`替换参数的问<br>题 |

## 近30天commit提交记录
| 提交时间 | 项目名称 | 更新内容 |
| :---- | :---- | :---- |
| 2022-11-08 12:25:49 | [ThunderSearch](https://github.com/xzajyjs/ThunderSearch) | update to v2.3.2 |
| 2022-11-17 14:37:23 | [subfinder](https://github.com/projectdiscovery/subfinder) | Merge pull request #712 from projectdiscovery/devv2.5.5 |
...
| 2022-11-23 13:31:50 | [dirsearch](https://github.com/maurosoria/dirsearch) | Merge pull request #1248 from drego85/patch-12Useful Files <br>and Directory for the SIMOGEO FileManager exploit |
| 2022-11-16 22:53:02 | [feroxbuster](https://github.com/epi052/feroxbuster) | Merge branch 'main' of github.com:epi052/feroxbuster |
| 2022-10-31 02:32:49 | [xray](https://github.com/chaitin/xray) | Fix Python3 Flask bug: ImportError: cannot import name 'esc<br>ape' from 'jinja2' (/usr/local/lib/python3.9/dist-packages/j<br>inja2/__init__.py) (#1680)Signed-off-by: DroidKali <DroidKal<br>i@users.noreply.github.com>Signed-off-by: DroidKali <DroidKa<br>li@users.noreply.github.com>Co-authored-by: DroidKali <Droid<br>Kali@users.noreply.github.com> |
...
| 2022-11-22 18:59:04 | [pocsuite3](https://github.com/knownsec/pocsuite3) | Merge pull request #341 from 13ph03nix/fix/console-use-comm<br>andfix: use command in console mode use absolute path |
...
| 2022-11-17 14:27:09 | [wpscan](https://github.com/wpscanteam/wpscan) | Merge pull request #1756 from wpscanteam/dependabot/bundler<br>/rspec-tw-3.12.0Update rspec requirement from ~> 3.11.0 to ~<br>> 3.12.0 |
...
| 2022-11-04 03:20:29 | [JSFScan.sh](https://github.com/KathanP19/JSFScan.sh) | Merge pull request #38 from jamboro/jacmo_targetescapeUpdat<br>e JSFScan.sh |
...
| 2022-11-25 14:53:59 | [BurpSuite-collectio<br>ns](https://github.com/Mr-xn/BurpSuite-collections) | add BpScan一款用于辅助渗透测试工程师日常渗透测试的Burp被动<br>漏扫插件(SpringSpiderScan、Log4jScan和FastJsonScan) |
| 2022-11-20 10:24:53 | [domain_hunter_pro](https://github.com/bit4woo/domain_hunter_pro) | Update DomainManager.javaCopyOnWriteArraySet 用iterator的re<br>move反而会出错 |
...
| 项目名称 | 版本 | 项目描述 |
| :---- | :---- | :---- |
| [pocsuite3](https://github.com/knownsec/pocsuite3) | v2.0.1 | pocsuite3 is an open-sourced remote vulnerability testing framew<br>ork developed by the Knownsec 404 Team. |
#### 数据库利用
| 项目名称 | 版本 | 项目描述 |
| :---- | :---- | :---- |
