...
|2022-11-22 10:33:20|[log4j2burpscanner](https://github.com/f0ng/log4j2burpscanner)|0.20.1|# 0.20.1更新## 2022-11-22- 修复`.`替换<br>参数的问题- 由于版本更新，需要重新加载参<br>数，点击`Restore/Loading latest params`，<br>进行查看，编辑完成点击`Save configuration<br>`即可正常使用|
