...
工具插件|Burpsuite插件|https://github.com/NeoTheCapt/PowerScanner
工具插件|Burpsuite插件|https://github.com/F6JO/RouteVulScan
工具插件|Burpsuite插件|https://github.com/metaStor/SpringScan
工具插件|xray|https://github.com/zema1/yarx
工具插件|xray|https://github.com/phith0n/xray-poc-generation
'''
